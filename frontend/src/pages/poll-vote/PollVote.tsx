            ...
            <div className="w-full rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
                ...
                <div className="mb-8 space-y-2">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <span className="flex items-center gap-1 border border-blue-300/30 rounded-md bg-blue-50 
                    px-3 py-1 text-sm font-medium text-blue-600">
                                <Globe size={16} /> {question.visibility.charAt(0).toUpperCase() + question.visibility.slice(1)}
                            </span>

                            <span className={`flex items-center gap-1 rounded-md px-3 py-1 text-sm 
                ...
                >
                    {answers.map((answer) => (
                        <label
                            key={answer.id}
                            className={`flex cursor-pointer items-center gap-3 rounded-lg border p-3 transition-all ${selected === answer.id
